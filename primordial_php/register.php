<?php
    ...
    //查重，无查重则插入数据
    if($a > 0){
        echo '<script> alert(\'重复注册，请重新输入\'); location = "../html/device/register.html" </script>';
    }
    else{
        $sql2 = "INSERT INTO register(email, pwd, xlwb, txwb, qq, lname, age, phone, work, ads, section) value('$email', '$pass', '$xlwb', '$txwb', '$qq', '$lname', '$age', '$phone', '$work', '$address','$section')";
        $dml($sql2);
        echo '<script> alert(\'注册成功\'); location = "../html/index.html" </script>';
    }
